...
from runaway.core.model import AgentSnapshot, EvacuationModel, SimulationSnapshot
...
class PygameRendererAdapter:
    ...
    def render(self, snapshot: SimulationSnapshot) -> None:
        ...
        pygame.draw.rect(
            self._surface, _COLOR_LABEL_BORDER, floor_bg_rect, width=1, border_radius=6
        )
